...
function ThermostatCharacteristicsModule(homebridge) {
  ...
  EcoMode = function () {
    Characteristic.call(
      this,
      'Eco Mode',
      'D6D47D29-4639-4F44-B53C-D84015DAEBDB'
    )
    this.setProps({
      format: Characteristic.Formats.BOOL,
      perms: [
  ...
  FanTimerActive = function () {
    Characteristic.call(
      this,
      'Fan Timer Active',
      'D6D47D29-4640-4F44-B53C-D84015DAEBDB'
    )
    this.setProps({
      format: Characteristic.Formats.BOOL,
      perms: [
  ...
  FanTimerDuration = function () {
    Characteristic.call(
      this,
      'Fan Timer Duraton',
      'D6D47D29-4641-4F44-B53C-D84015DAEBDB'
    )
    this.setProps({
  ...
  HasLeaf = function () {
    Characteristic.call(
      this,
      'Has Leaf',
      'D6D47D29-4642-4F44-B53C-D84015DAEBDB'
    )
    this.setProps({
      format: Characteristic.Formats.BOOL,
  ...
  ManualTestActive = function () {
    Characteristic.call(
      this,
      'Manual Test Active',
      'D6D47D29-4643-4F44-B53C-D84015DAEBDB'
    )
    this.setProps({
      format: Characteristic.Formats.BOOL,
      perms: [Characteristic.Perms.READ, Characteristic.Perms.NOTIFY],
  ...
  SunlightCorrectionEnabled = function () {
    Characteristic.call(
      this,
      'Sunlight Correction Enabled',
      'D6D47D29-4644-4F44-B53C-D84015DAEBDB'
    )
    this.setProps({
      format: Characteristic.Formats.BOOL,
      perms: [Characteristic.Perms.READ, Characteristic.Perms.NOTIFY],
  ...
  SunlightCorrectionActive = function () {
    Characteristic.call(
      ...
      'D6D47D29-4645-4F44-B53C-D84015DAEBDB'
    )
    this.setProps({
      format: Characteristic.Formats.BOOL,
      perms: [Characteristic.Perms.READ, Characteristic.Perms.NOTIFY],
  ...
  UsingEmergencyHeat = function () {
    Characteristic.call(
      ...
      'D6D47D29-4646-4F44-B53C-D84015DAEBDB'
    )
    this.setProps({
      format: Characteristic.Formats.BOOL,
      perms: [Characteristic.Perms.READ, Characteristic.Perms.NOTIFY],
...
export default ThermostatCharacteristicsModule
